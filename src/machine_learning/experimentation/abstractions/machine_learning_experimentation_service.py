...
class MachineLearningExperimentSettings(ExperimentSettings):    
    ...
    evaluation_dataset_settings: List[Dict[Dict[str, Any]]]
    training_dataset_settings: List[Dict[Dict[str, Any]]]
    evaluation_metric_settings: List[Dict[Dict[str, Any]]]
    objective_function_settings: List[Dict[Dict[str, Any]]]
    stop_condition_settings: List[Dict[Dict[str, Any]]]
...
class MachineLearningRunSettings():    
    ...
    evaluation_dataset_settings: Dict[Dict[str, Any]]
    training_dataset_settings: Dict[Dict[str, Any]]
    evaluation_metric_settings: Dict[Dict[str, Any]]
    objective_function_settings: Dict[Dict[str, Any]]
    stop_condition_settings: Dict[Dict[str, Any]]
