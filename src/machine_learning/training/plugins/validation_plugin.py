...
from ..batch_training_service import TrainingContext, PostEpoch
...
class ValidationPlugin(PostEpoch[TInput, TTarget, TModel]):
    ...
    def __execute_post_validation_plugins(self, logger: Logger, context: TrainingContext[TInput, TTarget, TModel], validation_result: EvaluationResult):
