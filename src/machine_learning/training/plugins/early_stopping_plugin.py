...
from ...training.batch_training_service import TrainingContext, TModel
from typing import *
...
class StopCondition(Generic[TInput, TTarget, TModel], ABC):
    ...
    @abstractmethod
    def is_satisfied(self, logger: Logger, training_context: TrainingContext[TInput, TTarget, TModel], validation_result: EvaluationResult) -> bool:
        pass

StopConditions = Dict[str, StopCondition[TInput, TTarget, TModel]]

class EarlyStoppingPlugin(PostValidationPlugin[TInput, TTarget, TModel]):
    ...
    def post_validation(self, logger: Logger, training_context: TrainingContext[TInput, TTarget, TModel], validation_result: EvaluationResult):
